...
export const metadata: Metadata = {
  title: 'Politique de confidentialité | VistaFlow',
}
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 px-6 py-16 text-white/80">
      <div className="space-y-3">
        <p className="text-xs uppercase tracking-[0.6em] text-white/40">VistaFlow</p>
      ...
      <section className="space-y-3">
        ...
        <p>
          Nous collectons les informations nécessaires pour fournir la plateforme VistaFlow : données de compte
      ...
      <section className="space-y-3">
        ...
        <p>
          VistaFlow applique chiffrement AES-256 des secrets, HTTPS, contrôle d’accès par workspace, audits de logs
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          <a className="text-white underline" href="mailto:privacy@vistaflow.ai">
            privacy@vistaflow.ai
          </a>
          . Nous répondons sous 30 jours. Vous pouvez révoquer l’accès VistaFlow dans les paramètres de chaque réseau
          social.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          Pour supprimer définitivement vos données collectées via VistaFlow (comptes connectés, interactions,
      ...
      <section className="space-y-3">
        ...
        <p>
          VistaFlow – 42 rue des Créateurs, 75010 Paris, France. Email :{' '}
          <a className="text-white underline" href="mailto:hello@vistaflow.ai">
            hello@vistaflow.ai
          </a>
        </p>
      </section>
