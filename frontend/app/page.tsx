...
export default function LandingPage() {
  return (
    <>
      <Navbar />
      <div className="space-y-24 pt-24 pb-16 px-4">
      <section className="relative mx-auto max-w-6xl overflow-hidden rounded-[40px] border border-white/10 bg-gradient-to-br from-[#0C0F17] via-[#090B12] to-[#05070C] px-8 py-12 shadow-[0_40px_120px_rgba(4,7,18,0.65)]">
